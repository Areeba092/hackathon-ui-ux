          ...
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              <div className="w-8 h-8">
                <img className="w-full h-full" src="/fb.png" alt="" />
              </div>
              {/* Placeholder for social icon */}
              <div className="w-8 h-8">
                <img className="w-full h-full" src=  "/insta.png"alt="" />
              </div>
              {/* Placeholder for social icon */}
              <div className="w-8 h-8">
                <img className="w-full h-full" src="/pinterest.png" alt="" />
              </div>
              {/* Placeholder for social icon */}
              <div className="w-8 h-8">
                <img className="w-full h-full" src="/yt.png"alt="" />
              </div>
              {/* Placeholder for social icon */}
            </div>
          </div>
